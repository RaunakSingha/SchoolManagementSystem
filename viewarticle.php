...
<center>
<br />
<h2 style="text-align:center; color:green">Uploaded Articles</h2>
<br />
<?php
        ...
        if(mysql_affected_rows()>0)
        {
            ...
            echo "<tr><th>Student Name</th><th>View Article</th></tr>";
            while($row=  mysql_fetch_array($res))
            {
                echo "<tr><td>$row[0]</td><td><a href='$row[1]'>$row[2]</a></td></tr>";
            }
            echo "</table>";
        }
        else 
        {
            echo "<center><strong>No Article Found</strong></center>";
        }
        mysql_close($h);
    ?>
...
<br />
<a href="articleoptions.php">Back to previous page</a>
