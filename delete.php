...
{	$msg="";$c=0;
	...
	$qry1="delete from students where roll='$_REQUEST[roll]'";
	$qry2="delete from marks where roll='$_REQUEST[roll]'";
	...
	if($c>0)
	$msg="<center><b><font color=green>Record Deletion Successful</font></b></center>";
	else
	$msg="<center><b><font color=red>Record Deletion Unsuccessful</font></b></center>";
	 }
 ?>
...
<form method="post">
<center><input type="text"  name="roll" value="" placeholder="Enter roll number "/><br />

<input type="submit" name="delete" value="DELETE ALL RECORDS" /></center>
<?php 
if(isset($_REQUEST['delete']))
{echo $msg;	} ?>
