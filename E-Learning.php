	...
	<header class="wrapper">
        ...
        <article class="bg-static-content">
        	<div class="page-header">
            	<h2>E-Learning</h2>
                <div class="quotes">" TOWARDS NEW HORIZON "</div>
                <p> In this age of automation computers are probably the biggest changes in education. St. Joseph's Convent Higher Secondary School has upgraded its teaching method introducing Digi-Classes from the year 2009. It has widened the vision of the teachers as well as the students as every subject is taught Interactive Board for better understanding and learning of the students. The newly furnished computer labs of both the buildings have opened new doors of knowledge for the students.</p>

<p>Modern technology mingled with the education in becoming a characteristic feature of the present educational system. SJCHSS became the first school in West Bengal to introduce this technology by installing Pearson Digi-Class. There was a dire needed for the credible platform which provides quality infrastructure; strong subject material and an environment conducive to optimal learning which would help children improve their academic performance.</p>

<p>The E-Learning & Digiclass advocates the use of a special software installed on all the laptops connected through Wi-Fi technology to the main server which comes with thousands of learning elements such as animations, videos, 3D interactivity, worksheets etc. which are all designed to ensure superior teaching / learning practices. The Digiclass uses an Electronic Interactive White Board where these audio visual explanations & animations are displayed. Digiclass introduced in our school is going a long way to enhance students' performance by facilitating long time retention and retrieval. The dynamic and interactive nature of it encourages active learning and brings the subject to life.</p>
            </div>
        </article>
    </div>
    <footer>
