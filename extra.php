	...
	<header class="wrapper">
        ...
        <article class="bg-static-content">
        	<div class="page-header">
                ...
                <div class="one-third">
                	<img class="static-thumb" src="images/extra.jpg"/>
                </div>
                <div class="two-third last">
				<div class="quotes">"Practice as if you are the worst perform as if you are the best."</div>
				<p>Co-Curricular Activities are those activities which are normally proposed by SJCHSS and basically meant for ..... the hidden talents from the sky and shaky children and also creates opportunities for those budding stars who want to exhibit their multifarious talents.</p>
<p>The Co-curricular club of SJCHSS conducts activities such as extempore elocution, debate, quiz, essay, poetry writing, creating stories and help the students to break through the nutshells and gain confidence. </p>
				</div>
                <div class="clearfix">&nbsp;</div>
            </div>
        </article>
