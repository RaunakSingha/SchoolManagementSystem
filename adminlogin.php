...
?>
 ...
 <?php $msg=""; 
	if(isset($_REQUEST['Login']))
	{
			...
			$qry="select * from admin where Password='$_REQUEST[password]' and Name='$_REQUEST[adminnm]'";
			...
			{
				$msg="<font color='#FF0000'><center>Invalid Name or Password</center></font>";
				}
		}?>
...
<link rel="stylesheet" type="text/css" href="css/custom-style.css">
 <link type="text/css" href="css/menu.css" rel="stylesheet" />
  ...
  <div class="">
    ...
    <form method="post">
    <h2><center><label><marquee behavior="alternate" >Enter Admin Name and Password</marquee></label></h2></center>      
    <center><h3>Enter Name:</h3></center>
    <br />
    <center><input type="text" name="adminnm" value="<?php if(isset($_REQUEST['Login']))
{echo $_REQUEST['adminnm'];}?>" placeholder="Enter admin name" /> </center>
    ...
    <center><input type="password" placeholder="Enter Passowrd" name="password"/>
      <br /><br />
      <input title="Login" type="submit" value="Log In" name="Login" /></center>
      <br />
     <?php
if(isset($_REQUEST['Login']))
{ 
