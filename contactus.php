...
<link rel="stylesheet" type="text/css" href="css/custom-style.css">
 <link type="text/css" href="css/menu.css" rel="stylesheet" />
	...
	<header class="wrapper">
        ...
        <div class="bg-static-content">
        	<div class="map">
            	<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false">
				</script>
				<div style="overflow:hidden;height:300px;width:960px;">
				<div id="gmap_canvas" style="height:300px;width:960px;">
				</div>
				...
				function init_map()
				{
				var myOptions = {zoom:14,center:new google.maps.LatLng(23.8391826,86.89227230000006),mapTypeId: google.maps.MapTypeId.ROADMAP};
				map = new google.maps.Map(document.getElementById("gmap_canvas"), myOptions);
				marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(23.8391826, 86.89227230000006)});
				infowindow = new google.maps.InfoWindow({content:"<b>St,Joseph's Convent Hg. Sec. School" });
            ...
            <aside >
            	<h2>Contact Info</h2>
                	<h4>St. Joseph's Convent Hg. Sec. School</h4>
           		 	<p>D-26, Ashoke Avenue, P.O. Chittaranjan,<br/>
                       Burdwan - 713331,West Bengal<br/>
                    <strong>Phone:</strong> 0341 2535578 (K.G. & PRIMARY SECTION),<br/>
                            &nbsp;&nbsp;&nbsp;&nbsp;0341 2525445 (HIGHER SECONDARY SECTION)<br/>
                    <strong>FAX :</strong> 03412525183<br/>
            		<strong>Website :</strong>www.stjosephcrj.org<br/>
            		<strong>E-mail :</strong> sjccrj@gmail.com</p>
            </aside>
