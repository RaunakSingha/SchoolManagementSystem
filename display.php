...
$qry="select students.name,students.fname,students.mname,students.dob,students.gender,students.cno,students.class,students.roll,marks.marks,marks.attn,students.address from students,marks where students.pwd='$_SESSION[pwd]'";
...
<fieldset>
<legend><h1><?php echo $row[0],"'s";?> Details</h1></legend>
<center>
<table width="50%">
<tr>
<td align="center"><label>Student's Name:</label></td>
<td align="center"><input type="text" name="name" value="<?php echo $row[0]; ?>" id="t1" readonly="readonly"/></td>
</tr>
<tr>
<td align="center"><label>Father's Name:</label></td>
<td align="center"><input type="text" name="fname" value="<?php echo $row[1]; ?>" readonly="readonly"/></td>
</tr>
<tr>
<td align="center"><label>Mother's Name:</label></td>
<td align="center"><input type="text" name="mname" value="<?php echo $row[2]; ?>" readonly="readonly"/></td>
</tr>
<tr>
<td align="center"><label>Date Of Birth:</label></td>
<td align="center"><input readonly="readonly" type="text" name="dob" value="<?php echo $row[3]; ?>"/></td>
</tr>
<tr>
<td align="center"><label>Gender:</label></td>
<td align="center"><input readonly="readonly" type="text" name="roll" value="<?php echo $row[4]; ?>"/></tr>
<tr>
<td align="center"><label>Contact No.:</label></td>
<td align="center"><input readonly="readonly" type="text" name="cno" value="<?php echo $row[5]; ?>"/></td>
</tr>
<tr>
<td align="center"><label>Class:</label></td>
<td align="center"><input readonly="readonly" type="text" name="roll" value="<?php echo $row[6]; ?>"/></td>
</tr>
<tr><td align="center"><label>Roll Number</label></td>
<td align="center"><input readonly="readonly" type="text" name="roll" value="<?php echo $row[7]; ?>"/></td></tr>
<tr>
<td align="center"><label>Marks:</label></td>
<td align="center"><input readonly="readonly" type="text" name="marks" value="<?php echo $row[8]; ?>"/></td>
</tr>
<tr>
<td align="center"><label>Attendance:</label></td>
<td align="center"><input readonly="readonly" type="text" name="attn" value="<?php echo $row[9]; ?>"/></td>
</tr>

<tr>
<td align="center"><label>Address:</label></td>
<td align="center"><textarea rows="5" cols="5" name="address" readonly="readonly"><?php echo $row[10]; ?></textarea></td>
</tr>
