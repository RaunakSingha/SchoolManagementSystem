...
{
		header("Location:viewnoticelist.php");
}
?>
...
<title>View Notices and Articles</title>
...
<link rel="stylesheet" type="text/css" href="css/custom-style.css">
 ...
 <div class="wrapper">
        ...
        <article class="bg-static-content">
            ...
            <center>
            <form>
            <input type="submit" value="UPLOADED BY STUDENTS" name="sub1" />
            
            <input type="submit" value="UPLOADED NOTICES" name="sub2" />
