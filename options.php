...
<link rel="stylesheet" type="text/css" href="css/custom-style.css">
 ...
 <div class="wrapper">
        ...
        <article class="bg-static-content">
            ...
            <center>
            <form>
            <input type="submit" value="NEW REGISTRATION" name="sub1" />
            
            <input type="submit" value="ENTER OR UPDATE RECORDS" name="sub2" />
            
            <input type="submit" value="DELETE RECORDS" name="sub3" />
            <input type="submit" value="UPLOAD NOTICES" name="sub4" />
            <input type="submit" value="ADD ADMIN" name="sub5" />
            </form>
            </center>
            <div class="clearfix">&nbsp;</div>
